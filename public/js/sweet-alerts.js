...
$(document).ready(function () {
  ...
  $("#html-alert").on("click", function () {
    Swal.fire({
      ...
      focusConfirm: false,
      confirmButtonText: '<i class="bx bx-like"></i> Great!',
  ...
  $("#type-success").on("click", function () {
    Swal.fire({
      ...
      confirmButtonClass: "btn btn-primary",
      buttonsStyling: false,
      confirmButtonText: "<a href='/login' style='color:#fff'>OK</a>",
    });
  });
  ...
  //   $(".swal2-confirm btn btn-primary").attr("href", "/login");
  // });
